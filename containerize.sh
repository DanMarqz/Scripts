...
read -p "~~~~>_  Por favor, indique el puerto de la imagen: " image_port 
...
run_command="docker run -it -d -p $image_port:$image_port $image_variables --name $image_name $docker_image"
